    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('admin.coupons.store') }}" method="POST">
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="kode" id="kode" value="{{ old('kode') }}" placeholder="Contoh: DISKON20"
                    ...
                    <div>
                        ...
                        <select name="tipe" id="tipe" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('tipe') border-red-500 @enderror">
                            <option value="fixed" {{ old('tipe') === 'fixed' ? 'selected' : '' }}>Tetap (Rp)</option>
                            <option value="percent" {{ old('tipe') === 'percent' ? 'selected' : '' }}>Persen (%)</option>
                        </select>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="nilai" id="nilai" value="{{ old('nilai') }}" min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <input type="number" name="min_order" id="min_order" value="{{ old('min_order', 0) }}" min="0"
                ...
                <div>
                    ...
                    <input type="number" name="max_uses" id="max_uses" value="{{ old('max_uses', 0) }}" min="0"
            ...
            <div class="mt-6 flex items-center gap-4">
                <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors font-medium">Simpan Kupon</button>
